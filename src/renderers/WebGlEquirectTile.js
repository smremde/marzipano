...
var fragmentSrc = require('../shaders/fragmentEquirectTile');
...
var uniformList = [
  ...
  'uColorOffset', 'uColorMatrix', 'uSphereX', 'uSphereY', 'uSphereWidth',
  'uSphereHeight'
];


/**
 * @class WebGlEquirectTiledRenderer
 * @implements Renderer
 * @classdesc
 *
 ...
 */
function WebGlEquirectTileRenderer(gl) {
  this.gl = gl;
...
WebGlEquirectTileRenderer.prototype.destroy = function() {
...
WebGlEquirectTileRenderer.prototype.startLayer = function(layer, rect) {
  var gl = this.gl;
...
WebGlEquirectTileRenderer.prototype.endLayer = function(layer, rect) {
  var gl = this.gl;
  var shaderProgram = this.shaderProgram;
...
WebGlEquirectTileRenderer.prototype.renderTile = function(tile, texture, layer, layerZ) {
  var gl = this.gl;
  var shaderProgram = this.shaderProgram;
  var constantBuffers = this.constantBuffers;
  ...
  gl.uniform1f(shaderProgram.uSphereX, tile.minX());
  gl.uniform1f(shaderProgram.uSphereY, tile.minY());
  gl.uniform1f(shaderProgram.uSphereWidth, 1/tile.scaleX());
  gl.uniform1f(shaderProgram.uSphereHeight, 1/tile.scaleY());
...
module.exports = WebGlEquirectTileRenderer;
